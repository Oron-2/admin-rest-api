...
app.put("/users/login", function (req, res) {
    ...
    if (!req.body.email || !req.body.password) {
        ...
        // If req.body.email and req.body password are present, the logAdminUser() function is called
        // that wil compare the two values against what's in the database. That function will reside in the 
        // /routes/admin-user/api.js file
